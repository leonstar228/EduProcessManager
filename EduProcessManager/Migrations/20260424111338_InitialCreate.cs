    ...
    public partial class InitialCreate : Migration
    {
        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_EduEvents", x => x.Id);
                    table.ForeignKey(
                        name: "FK_EduEvents_AspNetUsers_CreatedById",
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    Id = table.Column<int>(type: "int", nullable: false)
                        .Annotation("SqlServer:Identity", "1, 1"),
                    EduEventId = table.Column<int>(type: "int", nullable: false),
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_EventRegistrations_AspNetUsers_StudentId",
                        column: x => x.StudentId,
                        principalTable: "AspNetUsers",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Restrict);
                    table.ForeignKey(
                        name: "FK_EventRegistrations_EduEvents_EduEventId",
                        column: x => x.EduEventId,
                        principalTable: "EduEvents",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Restrict);
                });
            ...
            migrationBuilder.CreateIndex(
                name: "IX_EduEvents_CreatedById",
                table: "EduEvents",
                column: "CreatedById");

            migrationBuilder.CreateIndex(
                name: "IX_EventRegistrations_EduEventId_StudentId",
                table: "EventRegistrations",
                columns: new[] { "EduEventId", "StudentId" },
                unique: true);
